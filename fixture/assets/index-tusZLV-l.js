...
` +
    ...
    function Hc(e, t, n) {
      ...
      switch ((Vi(t), t.tag)) {
        ...
        case 4:
          return (
            xe(), e === null && Sd(t.stateNode.containerInfo), B(t), null
          );
        case 10:
...
const g = function (e, t, n) {
  ...
  _ = () => {
    ...
    return (
      e.current++,
      e.current > 10 && g(() => import(`./String-TCAWuh-O.js`), []),
      (0, f.useEffect)(() => {}, []),
      `Hello`
    );
  },
  v = () => (
    (0, f.useEffect)(() => {}, []),
    (0, u.jsx)(u.Fragment, { children: (0, u.jsx)(_, {}) })
  );
var y = document.getElementById(`root`);
if (!y) throw Error(`App root not found`);
(0, d.createRoot)(y).render((0, u.jsx)(v, {}));
export { i as t };
